...
export function loadAppYaml(startDir) {
    ...
    if (!parsed.web || typeof parsed.web !== "object") {
        throw new Error(`rome: app.yaml is missing "web" section — required when running rome dev/build`);
    }
    ...
    const appRoot = typeof parsed.appRoot === "string" && parsed.appRoot.length > 0 ? parsed.appRoot : undefined;
    return {
        appDir,
        yaml: {
            id: parsed.id,
...
//# sourceMappingURL=loadAppYaml.js.map