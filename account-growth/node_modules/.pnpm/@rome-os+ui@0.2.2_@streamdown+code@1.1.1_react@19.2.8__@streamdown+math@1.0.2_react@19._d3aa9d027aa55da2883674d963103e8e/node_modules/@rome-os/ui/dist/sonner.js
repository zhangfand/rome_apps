...
const iconClassName = "flex shrink-0 items-center justify-start [&_svg:not([class*='size-'])]:size-4";
const controlClassName = "inline-flex h-6 shrink-0 items-center justify-center rounded-[var(--control-r-sm)] border border-transparent px-2 text-badge outline-none transition-colors focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-0 focus-visible:outline-ring disabled:cursor-not-allowed disabled:opacity-50";
...
export function Toaster({ className, icons, style, toastOptions, ...props }) {
    return (_jsx(Sonner, { ...props, className: cn("toaster group", className), 
        ...
        icons: {
            ...
            info: _jsx(InfoIcon, {}),
            warning: _jsx(TriangleAlertIcon, {}),
            error: _jsx(OctagonXIcon, {}),
            loading: _jsx(Loader2Icon, { className: "animate-spin" }),
            close: _jsx(XIcon, { className: "size-3" }),
            ...icons,
        }, style: style, toastOptions: {
            ...toastOptions,
