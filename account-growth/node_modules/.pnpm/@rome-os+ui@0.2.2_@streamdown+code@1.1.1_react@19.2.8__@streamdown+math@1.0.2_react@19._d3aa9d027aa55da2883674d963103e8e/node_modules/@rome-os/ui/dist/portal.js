 ...
 */
export function AutoPortal({ portal: Portal, children, }) {
    ...
    const resolveFromMarker = useCallback((node) => {
        if (!node)
            return;
    ...
    return (_jsxs(_Fragment, { children: [_jsx("span", { hidden: true, ref: resolveFromMarker }), _jsx(Portal, { container: container, children: children })] }));
}
