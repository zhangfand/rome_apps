 ...
 */
export const IconButton = forwardRef(function IconButton({ label, icon, size = "md", className, type = "button", ...rest }, ref) {
    return (_jsx("button", { ref: ref, type: type, "data-slot": "icon-button", "data-size": size, "aria-label": label, title: label, className: cn(
        ...
        "inline-flex shrink-0 items-center justify-center rounded-8 border border-transparent text-ui text-foreground transition hover:bg-surface-hover focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-0 focus-visible:outline-ring disabled:cursor-not-allowed disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", sizeClasses[size], className), ...rest, children: icon }));
});
