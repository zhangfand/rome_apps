...
export function Card({ className, ...props }) {
    return (_jsx("div", { "data-slot": "card", className: cn("flex flex-col gap-4 rounded-12 border border-border bg-surface py-4 text-surface-foreground", className), ...props }));
}
...
export function CardTitle({ className, ...props }) {
    return _jsx("h3", { "data-slot": "card-title", className: cn("text-section", className), ...props });
}
