...
const SIZE_MD = "h-[var(--control-h-md)] gap-[var(--control-gap)] rounded-[var(--control-r-md)] px-[var(--control-px-center-md)]";
...
const buttonVariants = cva("group/button inline-flex shrink-0 items-center justify-center border border-transparent text-ui whitespace-nowrap transition-all outline-none select-none focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-0 focus-visible:outline-ring active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:outline-solid aria-invalid:outline-2 aria-invalid:outline-offset-0 aria-invalid:outline-destructive [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", {
    variants: {
        variant: {
            ...
            destructive: "bg-destructive/10 text-destructive hover:bg-destructive/20 focus-visible:outline-destructive dark:bg-destructive/20 dark:hover:bg-destructive/30",
        ...
        size: {
            ...
            default: SIZE_MD,
            "icon-xs": "size-6 rounded-[var(--control-r-sm)] in-data-[slot=button-group]:rounded-8 [&_svg:not([class*='size-'])]:size-3",
            "icon-sm": "size-[var(--control-h-sm)] rounded-[var(--control-r-sm)] in-data-[slot=button-group]:rounded-8 [&_svg:not([class*='size-'])]:size-3.5",
...
function Button({ className, variant = "default", size = "md", shape = "square", align = "center", asChild = false, ...props }) {
    const Comp = asChild ? Slot : "button";
    return (_jsx(Comp, { "data-slot": "button", "data-variant": variant, "data-size": canonicalControlSize(size), "data-shape": shape, "data-align": align, className: cn(buttonVariants({ variant, size, shape, align, className })), ...props }));
}
