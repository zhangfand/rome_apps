 ...
 * dark mode.
 */
const pressedClasses = "bg-primary/15 text-primary hover:bg-primary/25 hover:text-primary dark:bg-primary/20 dark:hover:bg-primary/30";
/**
 ...
 */
export function Toggle({ pressed, onPressedChange, variant = "ghost", size = "md", className, ...rest }) {
    return (_jsx("button", { type: "button", "data-slot": "toggle", "data-size": canonicalControlSize(size), className: cn(buttonVariants({ variant, size }), pressed && pressedClasses, className), onClick: () => onPressedChange(!pressed), ...rest, "aria-pressed": pressed }));
}
