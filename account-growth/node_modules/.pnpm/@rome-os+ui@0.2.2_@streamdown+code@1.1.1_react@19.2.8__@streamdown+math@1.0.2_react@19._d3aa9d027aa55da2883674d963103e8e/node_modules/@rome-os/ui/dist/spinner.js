 ...
 * already have.
 */
export const Spinner = forwardRef(function Spinner({ size = "md", label = "Loading", className, ...rest }, ref) {
    return (_jsx(LoaderCircle, { ref: ref, role: "status", "aria-label": label, "data-slot": "spinner", "data-size": size, className: cn(
        ...
        "shrink-0 animate-spin motion-reduce:[animation-duration:2s]", sizeClasses[size], className), ...rest }));
});
