...
import { type Components, type MermaidOptions, type StreamdownProps } from "streamdown";
export type { Components, MermaidConfig, MermaidOptions, StreamdownProps };
export declare const MARKDOWN_LINK_CLASS = "wrap-anywhere text-primary underline";
export type MarkdownLinkProps = ComponentPropsWithoutRef<"a"> & {
    node?: unknown;
    ref?: unknown;
};
export declare function MarkdownLink({ children, href, node: _node, target: _target, rel: _rel, className: _className, ref: _ref, ...rest }: MarkdownLinkProps): import("react/jsx-runtime").JSX.Element;
...
export declare function readMarkdownMermaidTheme(theme?: MarkdownTheme): MermaidTheme;
declare function MarkdownImpl({ children, className, compact, preserveSoftBreaks, linkComponent, theme, controls, lineNumbers, }: MarkdownProps): import("react/jsx-runtime").JSX.Element;
