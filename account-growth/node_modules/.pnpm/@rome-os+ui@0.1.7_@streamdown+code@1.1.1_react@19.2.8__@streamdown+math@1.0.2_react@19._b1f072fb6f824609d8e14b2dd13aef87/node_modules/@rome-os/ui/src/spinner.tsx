 ...
 * 14px on a `--control-h-sm` row, 16px on a `--control-h-md` one — and a
 * spinner swapped in for a leading icon leaves the button exactly as wide as it
 * was.
 */
 ...
 * caller was passing anyway, and width stays stable because a `sm`/`md` Spinner
 * is exactly as wide as the icon it replaces (`{busy ? <Spinner size="sm" /> :
 * <Check />}`). A prop would buy nothing the caller doesn't already have.
 */
