    ...
    >
      <AutoPortal portal={DialogPrimitive.Portal}>
        ...
        <DialogPrimitive.Content
          ...
          className={cn(
            "fixed left-1/2 top-1/2 z-50 w-full -translate-x-1/2 -translate-y-1/2 rounded-xl border border-border bg-surface text-foreground shadow-2xl ring-1 ring-black/5",
            sizeClasses[size],
            className,
          )}
          {...rest}
