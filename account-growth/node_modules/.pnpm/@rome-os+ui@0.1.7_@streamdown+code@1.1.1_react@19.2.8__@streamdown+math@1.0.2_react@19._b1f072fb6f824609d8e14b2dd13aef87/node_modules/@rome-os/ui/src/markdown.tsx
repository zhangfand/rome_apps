...
function MarkdownImpl({
  ...
  const wrapperClass = cn(
    ...
    "break-words",
    compact &&
      "text-sm space-y-2 [&_h1]:text-base [&_h1]:mt-3 [&_h1]:mb-1 [&_h2]:text-sm [&_h2]:mt-3 [&_h2]:mb-1 [&_h3]:text-sm [&_h3]:mt-2 [&_h3]:mb-1 [&_h4]:text-xs [&_pre]:my-2 [&_ul]:my-1 [&_ol]:my-1 [&_blockquote]:my-2 [&_table]:my-2",
