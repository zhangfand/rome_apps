 ...
 *   - `rounded-lg`, the panel step of the radius scale, not `rounded-xl`.
...
export function Card({ className, ...props }) {
    return (_jsx("div", { "data-slot": "card", className: cn("flex flex-col gap-4 rounded-lg border border-border bg-surface py-4 text-surface-foreground", className), ...props }));
}
export function CardHeader({ className, ...props }) {
    return (_jsx("div", { "data-slot": "card-header", className: cn("@container/card-header grid auto-rows-min grid-rows-[auto_auto] items-start gap-1 px-4 has-data-[slot=card-action]:grid-cols-[1fr_auto] [.border-b]:pb-4", className), ...props }));
}
export function CardTitle({ className, ...props }) {
    return _jsx("h3", { "data-slot": "card-title", className: cn("text-title", className), ...props });
}
export function CardDescription({ className, ...props }) {
    return (_jsx("div", { "data-slot": "card-description", className: cn("text-body text-muted-foreground", className), ...props }));
}
...
export function CardFooter({ className, ...props }) {
    return (_jsx("div", { "data-slot": "card-footer", className: cn("flex items-center gap-2 px-4 [.border-t]:pt-4", className), ...props }));
}
