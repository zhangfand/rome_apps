 ...
 */
export function Toggle({ pressed, onPressedChange, variant = "ghost", size = "default", className, ...rest }) {
    return (_jsx("button", { type: "button", "data-slot": "toggle", className: cn(buttonVariants({ variant, size }), pressed && pressedClasses, className), onClick: () => onPressedChange(!pressed), ...rest, "aria-pressed": pressed }));
}
