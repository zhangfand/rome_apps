 ...
 */
export declare function SegmentedControl<T extends string = string>({ options, value, onValueChange, disabled, size, "aria-label": ariaLabel, className, }: SegmentedControlProps<T>): import("react/jsx-runtime").JSX.Element;
