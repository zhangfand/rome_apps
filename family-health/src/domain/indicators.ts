...
export const CATEGORIES: CategoryInfo[] = [
  ...
  { key: "lipid", zh: "血脂", order: 6 },
  { key: "glucose", zh: "血糖", order: 7 },
  { key: "thyroid", zh: "甲状腺功能", order: 8 },
  { key: "tumor", zh: "肿瘤标志物", order: 9 },
  { key: "bone", zh: "骨密度/骨代谢", order: 10 },
  { key: "coag", zh: "凝血功能", order: 11 },
  { key: "electrolyte", zh: "电解质", order: 12 },
  { key: "cardio", zh: "心血管/炎症", order: 13 },
  { key: "vitamin", zh: "维生素/营养", order: 14 },
  { key: "infection", zh: "感染/免疫", order: 15 },
];
...
export const INDICATORS: Def[] = [
  ...
  {
    code: "UA", zh: "尿酸", en: "Uric acid", category: "kidney", unit: "μmol/L", valueType: "numeric",
