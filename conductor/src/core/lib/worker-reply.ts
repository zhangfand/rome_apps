...
export function replyInstructions(): string {
  return [
    ...
    "summary: <one or two sentences: what you did and the key result (URL, artifact, finding, question)>",
    "```",
    "",
    ...
    "- waiting: something external must happen first (an approval, a response, a scheduled event); say what, and suggest when to check again.",
    "",
